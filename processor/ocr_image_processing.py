...
class ImagePreprocessor:
    ...
    Key Tips:
    - Threshold Value: Start with 127, lower for thicker text (105), higher for thinner text (150)
    - Processing Order Matters: Each step affects the next
    - Grayscale usually gives best OCR results
    - Test OCR after each step - more processing isn't always better
    """
    ...
    def preprocess_pipeline(self, output_dir="temp/", save_intermediate=True):
        """
